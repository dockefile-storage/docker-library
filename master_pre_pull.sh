...
images=(k8s.gcr.io/kube-proxy-amd64:v1.11.2
...
pull_and_rename()
{
	...
	sudo docker pull ${REGISTRY_ALIYUNCS}/${NAME_SPACE}/$1

	echo "docker tag  ${REGISTRY_ALIYUNCS}/${NAME_SPACE}/$1 $2"
	sudo docker tag  ${REGISTRY_ALIYUNCS}/${NAME_SPACE}/$1 $2

	echo "docker rmi  ${REGISTRY_ALIYUNCS}/${NAME_SPACE}/$1"
	sudo docker rmi  ${REGISTRY_ALIYUNCS}/${NAME_SPACE}/$1
}
